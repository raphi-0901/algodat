...
public class GraphUtil {
    ...
    public static <VertexT extends Vertex, EdgeT extends Edge> GraphMLImporter<VertexT, EdgeT> createImporter(VertexProvider<VertexT> vertexProvider, EdgeProvider<VertexT, EdgeT> edgeProvider) {
